  ...
  render() {
    ...
    return (
      ...
      <h1 className="SERVICES">
        {" "}
        <span className="first">OUR</span> SERVICES{" "}
      </h1>
    );
  }
}
...
//           {/* <a href  = "#" className = "btn" > {this.props.text} test<spaSymptomsSymptomsn className = "fas fa-chevron-right"></span> </a> */}
//           </div>
  ...
  render() {
    return (
      <div className="box">
        ...
        <Link to={this.props.link} className="btn">{this.props.button}<span className={this.props.icon}></span></Link>
      </div>
    );
  }
}
